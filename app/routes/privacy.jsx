...
export default function PrivacyPolicy() {
  return (
    <div style={{ padding: "40px", maxWidth: "800px", margin: "0 auto" }}>
      <BlockStack gap="500">
        <Text variant="headingXl" as="h1">Privacy Policy for Auto-Fulfillment</Text>
        <Card>
          <BlockStack gap="300">
            ...
            <Text as="p">Information is used solely to match submitted invoice or order numbers to Shopify orders.</Text>
