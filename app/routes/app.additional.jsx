...
export default function FulfillmentLogs() {
  ...
  return (
    <Page title="Fulfillment History" subtitle="Track every order processed by the fulfillment API.">
      <BlockStack gap="500">
        {rows.length > 0 ? (
          <Card padding="0">
            <DataTable
          ...
          <Card>
            ...
            >
              <p>Once you send your first fulfillment API request, logs will appear here.</p>
            </EmptyState>
          </Card>
        )}
      </BlockStack>
